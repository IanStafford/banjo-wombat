...
proc Tgate {Ins} {
    ...
    if {$Ins} {
	line x loc=-0.001 spac=0.001 tag=GateIns
    }
    ...
    #Nitride between gate and AlGaN?
    if {$Ins} {
	#Metal alloy for T-gate
	region Metal xlo=Gwt xhi=Gwb ylo=sidewL yhi=sidewR
	region Metal xlo=Gwb xhi=GateIns ylo=sidenL yhi=sidenR
	region Nitride xlo=GateIns xhi=AlGaNTop ylo=sidenL yhi=sidenR
    } else {
	#Metal alloy for T-gate
	region Metal xlo=Gwt xhi=Gwb ylo=sidewL yhi=sidewR
    ...
    region HighK xlo=Ox xhi=AlGaNTop ylo=Left yhi=sidenL
    region HighK xlo=Ox xhi=AlGaNTop ylo=sidenR yhi=Right
