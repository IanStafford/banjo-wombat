...
proc HEMT_Struct { } {
    ...
    line x loc=-0.26 spac=0.025 tag=top
    line x loc=-0.16 spac=0.025 tag=topIns
    ...
    #Contacts
    contact name=FP Metal xlo=[expr -0.26-$buf] xhi=[expr -0.26+$buf] ylo=[expr $Gtr] yhi=[expr $Gtr+$FP2] add depth=1.0 width=1.0
